...
enum {
	...
	DEVICE_STATUS_FFUNFL  = 0x40,
	DEVICE_STATUS_FFOVFL  = 0x80
};

enum {
	INTERRUPT_STATUS_1_ICRERROR   = 0x01,
	INTERRUPT_STATUS_1_IPKVALID   = 0x02,
	INTERRUPT_STATUS_1_IPKSENT    = 0x04,
	INTERRUPT_STATUS_1_IEXT       = 0x08,
	INTERRUPT_STATUS_1_IRXFFAFULL = 0x10,
	INTERRUPT_STATUS_1_ITXFFAEM   = 0x20,
	INTERRUPT_STATUS_1_ITXFFAFULL = 0x40,
	INTERRUPT_STATUS_1_IFFERR     = 0x80
};

enum {
	INTERRUPT_STATUS_2_IPOR       = 0x01,
	INTERRUPT_STATUS_2_ICHIPRDY   = 0x02,
	INTERRUPT_STATUS_2_ILBD       = 0x04,
	INTERRUPT_STATUS_2_IWUT       = 0x08,
	INTERRUPT_STATUS_2_IRSSI      = 0x10,
	INTERRUPT_STATUS_2_IPREAINVAL = 0x20,
	INTERRUPT_STATUS_2_IPREAVAL   = 0x40,
	INTERRUPT_STATUS_2_ISWDET     = 0x80
};

enum {
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_XTON    = 0x01,
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_PLLON   = 0x02,
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_RXON    = 0x04,
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_TXON    = 0x08,
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_X32KSEL = 0x10,
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_ENWT    = 0x20,
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_ENLBD   = 0x40,
	OPERATING_MODE_AND_FUNCTION_CONTROL_1_SWRES   = 0x80
};
enum {
	OPERATING_MODE_AND_FUNCTION_CONTROL_2_FFCTRTX = 0x01,
	OPERATING_MODE_AND_FUNCTION_CONTROL_2_FFCLRRX = 0x02,
	OPERATING_MODE_AND_FUNCTION_CONTROL_2_ENLDM   = 0x04,
	OPERATING_MODE_AND_FUNCTION_CONTROL_2_AUTOTX  = 0x08,
